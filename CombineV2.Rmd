...
# default footnote is today's date, cex = 0.7 (size) and color is a kind of grey

makeFootnote <- function(footnoteText = format(Sys.time(), "%d %b %Y"), size = 0.7, color = grey(0.5)) {
  require(grid)
